            ...
            {/* ========Latest Job Listing=============*/}
                    <div className="grid sm:grid-cols-1 md:grid-cols-2 2xl:grid-cols-3 mt-12 md:mt-20 gap-12 2xl:gap-10 text-left">
                        {fullTimeJobs.map((job) => (
                            <a key={job.id} href={`/careers/${job.slug}`} className="dark:bg-white2 dark:shadow content-between grid-rows-[auto auto auto auto] grid group font-body px-7 2xl:px-7 xl:px-5 py-10 shadow-3xl rounded-2xl "> 
