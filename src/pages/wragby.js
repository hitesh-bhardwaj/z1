...
export default function wragby() {
  ...
  return (
    ...
    <NextSeo
      title="Wragby Solutions | Case Study"
      description="Wragby case study showcases the work done by Enigma in Branding, UI/UX design and front-end development, driving exceptional results for the client."
      canonical="https://www.weareenigma.com/wragby"
      openGraph={{
        url: "https://www.weareenigma.com/wragby",
        title: "Wragby Solutions | Case Study",
        description:
          "Wragby case study showcases the work done by Enigma in Branding, UI/UX design and front-end development, driving exceptional results for the client.",
        images: [
          {
            url: "",
            width: 400,
        ...
        siteName: "https://www.weareenigma.com/wragby",
      }}
    />    

      <Head>
        <title>Wragby Solutions | Case Study</title>
        <meta name="description" content="Wragby case study showcases the work done by Enigma in Branding, UI/UX design and front-end development, driving exceptional results for the client." />
      ...
      <main>
        ...
        <div className={styles.Main}>
          ...
          <div className={styles.videoHeading}>
            <h1>The African Technology Behemoth</h1>
          </div>
