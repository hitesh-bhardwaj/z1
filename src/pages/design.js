...
{/* Hero Section*/}
        <section className={`${styles['service-detail-hero']} ${styles['main-container']}`} data-cursor-size="10px" data-cursor-text="">
          <div className={`${styles['service-detail-hero-content']} ${styles['hero-content']}`}>
            <div className={`${styles['service-detail-hero-top']} ${styles['design']}`}>
            ...
            <div>
              <h1 className={`${styles['hero-bottom']} ${styles['design']}`} id='service-anim' data-cursor-magnetic data-cursor-background-image="/assets/gif/5.gif" data-cursor-size="300px" data-cursor-color="#000">
                Design
              </h1>
            </div>
          </div>
