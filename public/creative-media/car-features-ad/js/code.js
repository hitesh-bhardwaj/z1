  ...
  var oNames = {
    id: 'adArea p1 p2 p3 p4 p5 p6 picCont t2 pluses darker clickArea pic1Anim pic2Anim pic3Anim pic4Anim pic5Anim pic6Anim',
  }
...
function activatePluses(){
  ...
  plusesList = ['p1', 'p2', 'p3', 'p4', 'p5', 'p6'];
  pPos = [ [119, 84], [140, 56], [129, 125], [47, 88], [222, 99], [175, 68] ];
  var scale = 0.5;
  var ady = 0;
  pFix = { x: -20, y: -20 };
